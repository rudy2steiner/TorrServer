...
func getMagnet(minfo *metainfo.MetaInfo, info metainfo.Info) metainfo.Magnet {
	// return minfo.Magnet(info.Name, minfo.HashInfoBytes())
	return minfo.Magnet(nil, &info)
}
